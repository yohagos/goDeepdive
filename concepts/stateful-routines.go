...
// memory by communicating and having each piece of data owned by 
// exactly 1 goroutine.
...
func StatefulRoutines() {
	...
	// Here is the goroutine that owns the state, which is a map as 
	// in the previous example but now private to the stateful 
	...
	// resp to indicate success (and the desired value in the 
	// case of reads).
	go func() {
