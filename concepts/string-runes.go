...
func StringsRunes() {
	...
	// utf8 package. Note that the run-time of RuneCountInString
	// depends on the size of the string, because it has to decode
	// each UTF-8 rune sequentially. Some Thai characters are
