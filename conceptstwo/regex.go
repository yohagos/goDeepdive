...
func Regex() {
	...
	// For example this will return information for both p([a-z]+)ch
	// and ([a-z]+).
	...
	// can use the MustCompile variation of Compile. MustCompile
	// panics instead of returning an error, which makes it safer
